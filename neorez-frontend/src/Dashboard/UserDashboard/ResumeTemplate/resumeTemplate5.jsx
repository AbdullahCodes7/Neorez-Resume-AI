...
const ResumeTemplate5 = () => {
  ...
  const [workExperiences, setWorkExperiences] = useState([
    ...
    {
      id: 2,
      title: "UX Designer, Resume Worded",
    ...
    {
      id: 3,
      title: "Associate UX Designer, Growshi",
      company: "Resume Worded",
      date: " Sep 2017 – Sep 2019",
      description:
        "Redesigned company’s homepage and lead generation forms using existing design system; reduced bounce rates by 40% and increased leads by 15%. Designed an online customer support center comprising of a self-service knowledge base and interactive chat bot. Coached 3 summer interns.",
    },
    {
      id: 4,
      title: "UX Analyst, Growshi",
      company: "Resume Worded",
      date: " Sep 2017 – Sep 2019",
      description:
        "Redesigned company’s homepage and lead generation forms using existing design system; reduced bounce rates by 40% and increased leads by 15%. Designed an online customer support center comprising of a self-service knowledge base and interactive chat bot. Coached 3 summer interns.",
  ...
  return (
    <div className=" resumeTemplate bg-white ">
      <div className="border flex flex-col gap-6 px-7">
        <div>
        ...
        <div className=" px-7">
          ...
          <div>
            {workExperiences.map((experience) => (
              <div key={experience.id} className="mb-6 grid grid-cols-2">
                {/* Date */}
                <div onClick={() => handleEditorClick(`date-${experience.id}`)}>
        ...
        <div className="px-7">
          ...
          <div>
            {education.map((edu) => (
              <div key={edu.id} className="grid grid-cols-2 gap-y-4">
                 {/* date */}
                 <div>
                ...
                <div >
                  ...
                  {activeEditor === `degree-${edu.id}` ? (
                    ...
                    <div
                      className="para-ex-small font-normal font-poppin mb-4"
        ...
        <div>
          <div className="flex justify-start  gap-48  px-7 mb-4">
            <div>
              <h4 className="para-small font-semibold font-poppin">
                Skills
              </h4>
            </div>
