...
const ResumeTemplate2 = () => {
  ...
  const handleAboutChange = (index, field, value) => {
    const updatedAbout = [...resume.about];
    updatedAbout[index] = { ...updatedAbout[index], [field]: value };
    setResume({ ...resume, about: updatedAbout });
  };

  const handleJobExperienceChange = (index, field, value) => {
    const updatedExperiences = [...resume.jobExperiences];
    updatedExperiences[index] = {
      ...updatedExperiences[index],
      [field]: value,
    };
    setResume({ ...resume, jobExperiences: updatedExperiences });
  };
  ...
  const handleHobbiesChange = (index, field, value) => {
    ...
    setResume({ ...resume, hobbies: updatedHobbies });
  };
                    ...
                    <>
                      ...
                      >
                        ...
                        >
                          <p
                            ref={ref}
                            className="border-none outline-none font-Inter para-ex-small font-normal darkGray  text-left mt-3 "
                            contentEditable
                            suppressContentEditableWarning
                            onBlur={(e) => {
                              handleAboutChange(
                              ...
                              // setValue(e.target.textContent, index);
                            }}
                            onClick={() => {
                              // console.log("lala");
                              setTextIndex(index);
                            ...
                            // onInput={(e) =>
                            //   handleQuillChange(e.target.textContent, index)
                            // }
                            // onInput={(e) => {
                            //   setValue(e.currentTarget.textContent);
                            //   // handleQuillChange(index);
                            // }}
                          >
                            {parse(
                              about?.description ||
                                "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ullam nam quos alias sint. Incidunt iste impedit dolore rem id tenetur enim, blanditiis vitae, laboriosam cum repellat explicabo et officia sit?"
                            )}
                          </p>
                        </div>
                      </Popover>
